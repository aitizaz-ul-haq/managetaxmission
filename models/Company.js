...
const CompanySchema = new mongoose.Schema(
  {
    ...
    // FBR sandbox/production tokens — issued per seller NTN by FBR. Attached to this
    // company's invoices when calling the bridge so FBR accepts the seller/token pairing.
    fbrSandboxToken: { type: String, default: '', trim: true },
    fbrProductionToken: { type: String, default: '', trim: true },
